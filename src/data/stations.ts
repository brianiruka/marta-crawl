...
export const stations: Station[] = [
  ...
  { id: "west-lake", name: "West Lake", lines: ["blue"], x: 634, y: 1394, angle: -45 },
  { id: "ashby", name: "Ashby", lines: ["blue", "green"], interchange: true, x: 734, y: 1369, angle: -45 },
  { id: "vine-city", name: "Vine City", lines: ["blue", "green"], interchange: true, x: 788, y: 1385, angle: -45 },
  { id: "sec-district", name: "SEC District", lines: ["blue", "green"], interchange: true, x: 846, y: 1397, angle: -45 },
  { id: "georgia-state", name: "Georgia State", lines: ["blue", "green"], interchange: true, x: 1181, y: 1215, angle: -45 },
  { id: "king-memorial", name: "King Memorial", lines: ["blue", "green"], interchange: true, x: 1257, y: 1215, angle: -45 },
  { id: "inman-park-reynoldstown", name: "Inman Park/Reynoldstown", lines: ["blue", "green"], interchange: true, x: 1376, y: 1176, angle: -45 },
  { id: "edgewood-candler-park", name: "Edgewood/Candler Park", lines: ["blue", "green"], interchange: true, x: 1454, y: 1184, angle: -45 },
  { id: "east-lake", name: "East Lake", lines: ["blue"], x: 1525, y: 1262, angle: -45 },
  { id: "decatur", name: "Decatur", lines: ["blue"], x: 1587, y: 1270, angle: -45 },
  { id: "avondale", name: "Avondale", lines: ["blue"], x: 1671, y: 1266, angle: -45 },
  { id: "kensington", name: "Kensington", lines: ["blue"], x: 1767, y: 1258, angle: -45 },
  { id: "indian-creek", name: "Indian Creek", lines: ["blue"], terminal: true, x: 1867, y: 1250, angle: -45 },
];
