...
export const stations: Station[] = [
  ...
  { id: "doraville", name: "Doraville", lines: ["gold"], terminal: true, x: 1531, y: 456, angle: 0 },
  { id: "chamblee", name: "Chamblee", lines: ["gold"], x: 1460, y: 529, angle: 0 },
  { id: "brookhaven-oglethorpe", name: "Brookhaven/Oglethorpe", lines: ["gold"], x: 1411, y: 578, angle: 0 },
  { id: "lenox", name: "Lenox", lines: ["gold"], x: 1342, y: 649, angle: 0 },
